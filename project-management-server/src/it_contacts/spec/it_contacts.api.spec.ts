// - /src/it_contacts/spec/it_contacts.api.spec.ts - it contacts validation

import * as request from 'supertest';
 describe('GET /it-contacts', () => {
   it('should have the response', async () => {
    ...
    const response = await apiRequest.get('/it-contacts').set({"Authorization" : `Bearer ${token}`});
