// - /src/projects/spec/project-edit.api.spec.ts - edit project validation
...
import * as request from 'supertest';
 describe('POST /notes-add', () => {
   it('should have the response', async () => {
    ...
    const response = await apiRequest.put("/project/edit").set({"Authorization" : `Bearer ${token}`}).send(postData);
