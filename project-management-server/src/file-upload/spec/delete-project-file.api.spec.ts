// - /src/file-upload/spec/delete-project-file.api.spec.ts - delete project file validation

import * as request from 'supertest';

 describe('DELETE /delete-project-file', () => {
   it('should have the response', async () => {
    ...
    const response = await apiRequest.get('/files/1129/delete').set({"Authorization" : `Bearer ${token}`});
