"use client"
// - /notes/src/app/_modals/Projects/EditProject/EditProject/Mobile/EditProjectMobile - edit project mobile modal
...
// STYLES
import "./edit-project-mobile.css";
...
const EditProjectMobileModal: React.FC = () => {
  ...
  return (
    <Box className={theme.palette.mode === "dark" ? "wrapper-mobile-dark scrollbar-primary" : "wrapper-mobile scrollbar-primary"}>
      ...
      <Box className="project-type-component-mobile d-flex flex-direction-column"><ProjectTypeComponent /><Box className="mt-5"><ProjectStatusComponent /></Box></Box>
      {/* Project Type / Status Container Mobile End */}
      {/* It Contacts Container Mobile Start */}
      <Box className="It-contacts-component-mobile"><ItContactsEditComponent /></Box>
      ...
      <Box className="contact-container-mobile">
        ...
        <Box className="contact-container-grid-mobile">
          ...
          <Box className="client-contact-component-mobile mt-20"><ClientContactsComponent numRows={4}/></Box>
          {/* Client Contacts Component Mobile End */}
          {/* Supplier Contact Component Mobile Start */}
          <Box className="supplier-contact-component-mobile"><SupplierContactsComponent numRows={4}/></Box>
          {/* Supplier Contact Component Mobile End */}
          {/* ERP Contacts Component Mobile Start */}
          <Box className="erp-contact-component-mobile"><ErpContactsComponent numRows={4}/></Box>
...
export default EditProjectMobileModal
