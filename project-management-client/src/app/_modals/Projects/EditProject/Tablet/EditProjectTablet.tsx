"use client"
// - /notes/src/app/_modals/Projects/EditProject/Tablet/EditProjectTablet - edit project tablet modal
...
// STYLES
import "./edit-project-tablet.css";
...
const EditProjectTabletModal: React.FC = () => {
    ...
    <Box className="modal-bg">
      ...
      <Box className={theme.palette.mode === "dark" ? "wrapper-tablet-dark scrollbar-primary" : "wrapper-tablet scrollbar-primary"}>
        ...
        <Box className="date-start-tablet">
          <Box><Typography variant="h6">Start Date</Typography></Box>
          <StartDateComponent />
          <Box className='mt-5'><Typography variant="h6">End Date</Typography></Box>
          <EndDateComponent />
        </Box>
        ...
        <Box className="It-contacts-component-tablet"><ItContactsEditComponent></ItContactsEditComponent></Box>
        ...
        <Box className="contact-container-tablet">
          ...
          <Box className="contact-container-grid-tablet">
            ...
            <Box className="client-contact-component-tablet mt-20"><ClientContactsComponent numRows={4}/></Box>
            {/* Client Contacts Tablet Container End */}
            {/* Supplier Contacts Tablet Component Start*/}
            <Box className="supplier-contact-component-tablet mt-20"><SupplierContactsComponent numRows={4}/></Box>
            {/* Supplier Contacts Tablet Component End */}
            {/* ERP Contact Tablet Component Start */}
            <Box className="erp-contact-component-tablet mt-20"><ErpContactsComponent numRows={4}/></Box>
...
export default EditProjectTabletModal
